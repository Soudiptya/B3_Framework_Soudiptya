...
public class ELearningSubscribeClassToCoursesPOM {
	
private WebDriver driver;
	
	public ELearningSubscribeClassToCoursesPOM(WebDriver driver) {
		this.driver = driver; 
	...
	@FindBy(xpath="//a[@href='add_courses_to_usergroup.php?id=69']//img[@title='Subscribe class to courses']")
